...
def get_train_test_data():
    train_df = pd.read_excel('E:/bert_keras_nlp-master/data/data_train.xlsx' ).astype(str)
    test_df = pd.read_excel('E:/bert_keras_nlp-master/data/data_test.xlsx').astype(str)
...
# 预训练好的模型 bert base
config_path     = 'E:/bert_keras_nlp-master/bert/bert_config.json' # 加载配置文件
checkpoint_path = 'E:/bert_keras_nlp-master/bert/bert_model.ckpt'
dict_path = 'E:/bert_keras_nlp-master/bert/vocab.txt'
